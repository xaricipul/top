...
function addRandomMessage() {
    const messages = [
        ...
        // { text: "Bir dakika hiç bir etkileşim yapmasan resim küçülecek", language: "tr" },
        // { text: "Malesef 3bin beğeniden sonra resim büyümüyor", language: "tr" },
        { text: "Arkadaşlarını davet et profil resmin büyüsün", language: "tr" },
        ...
        // { text: "Bir dakika hiç bir etkileşim yapmasan resim küçülecek", language: "tr" },
        // { text: "Arkadaşlarını davet et profil resmin büyüsün", language: "tr" },
        // { text: "Beğeni gönderenin profil resmi büyüyor", language: "tr" },

        { text: "Harikasınız", language: "tr" },
        // { text: "Birlikte büyüyelim, beğen ve takip et", language: "tr" },
        { text: "Topluluğa katıl,ve etkileşime gir", language: "tr" },
        ...
        // { text: "Bir dakika hiç bir etkileşim yapmasan resim küçülecek", language: "tr" },
        // { text: "Hesabımı takip edenin profil resmi büyüyor", language: "tr" },
        // { text: "En fazla 3bin beğeni göndere bilirsin", language: "tr" },
        // { text: "Malesef 3bin beğeniden sonra resim büyümüyor", language: "tr" },
        // { text: "3bin beğeniden sonra yayımı paylaşarak büyüye bilirsin", language: "tr" },
        // { text: "Arkadaşlarını davet et profil resmin büyüsün", language: "tr" },
        // { text: "Beğeni gönderenin profil resmi büyüyor", language: "tr" },

        { text: "Müthişsiniz, teşekkürler", language: "tr" },
        { text: "Pozitif enerjiyi sürdür, ", language: "tr" },
        { text: "Birlikte daha güçlüyüz, destekle ", language: "tr" },
        { text: "Paylaşmak önemsemektir, ", language: "tr" },
        { text: "Daha fazla içerik için takipte kal", language: "tr" },
        { text: "Yeni arkadaşlar keşfet,ve etkileşime gir", language: "tr" },
        { text: "Birbirimize ilham verelim, beğen ", language: "tr" },
        ...
        { text: "Beğeni bırak", language: "tr" },
        { text: "Harika işler çıkarmaya devam edin, teşekkürler", language: "tr" },
        { text: "Bağlan ve büyü,  ve destekle", language: "tr" },
        // { text: "Bir dakika hiç bir etkileşim yapmasan resim küçülecek", language: "tr" },
        // { text: "Hesabımı takip edenin profil resmi büyüyor", language: "tr" },
        // { text: "En fazla 3bin beğeni göndere bilirsin", language: "tr" },
        // { text: "Malesef 3bin beğeniden sonra resim büyümüyor", language: "tr" },
        ...
        { text: "Sohbete katıl, yorum yap ", language: "tr" },
        { text: "Yeni fikirler keşfet, ve paylaş", language: "tr" },
        { text: "Güncel kal, ve bildirimleri aç", language: "tr" },
        ...
        { text: "Pozitif bir topluluk oluştur,  ve etkileşime gir", language: "tr" },
        ...
        // { text: "Beğeni gönderenin profil resmi büyüyor", language: "tr" },
        // { text: "Canlını paylaşanın profil resmi büyüyor", language: "tr" },
        // { text: "Mesaj yazanın resmi büyüyor", language: "tr" },
        // { text: "Hesabımı takip edenin profil resmi büyüyor", language: "tr" },
        // { text: "Arkadaşlarını davet et profil resmin büyüsün", language: "tr" },
        // { text: "Bir dakika hiç bir etkileşim yapmasan resim küçülecek", language: "tr" },
        // { text: "Profil resmin arka plandakı resim kadar olduğunda kazanacaksın", language: "tr" },
        // { text: "En fazla 3bin beğeni göndere bilirsin", language: "tr" },
        // { text: "Malesef 3bin beğeniden sonra resim büyümüyor", language: "tr" },
        // { text: "3bin beğeniden sonra hediye ile büyüye bilirsin", language: "tr" },
        // { text: "3bin beğeniden sonra mesaj yazarak büyüye bilirsin", language: "tr" },
        // { text: "3bin beğeniden sonra yayımı paylaşarak büyüye bilirsin", language: "tr" },
