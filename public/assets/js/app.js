...
let availableMessages = [
  ...
  { text: "Gül gönderenin hesabı daha hızlı büyüyor", language: "tr" },
  ...
  { text: "Gül gönderenin resmi daha hızlı büyüyor", language: "tr" },
  { text: "Gül atanların hesabı daha çabuk büyüyor", language: "tr" },
  { text: "yayımı paylaşanın resmi büyüyor", language: "tr" },
  ...
  { text: "oyunu bitirenin hesab adı ekranda görünecek", language: "tr" },
  { text: "Güncellemeler için bildirimleri aç", language: "tr" },
  { text: "Gül atanların hesabı daha çabuk büyüyor", language: "tr" },
  { text: "Hesabı ekranda görüntülenene toplu takip gönderin", language: "tr" },
  { text: "yayımı beğenenin resmi büyüyor", language: "tr" },
{ text: "beğenme limitini geçerseniz resiminiz küçülür", language: "tr" },
  { text: "Hesabımı takip et hesabın ekranda görünsün", language: "tr" },
  ...
  { text: "gül gönderenin hesabı daha çabuk büyüyor", language: "tr" },
